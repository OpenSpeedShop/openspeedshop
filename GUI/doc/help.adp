...
<profile>
    ...
    <property name="title">OpenSpeeShop Documentation</property>
    ...
    <DCF ref="index.html" icon="handbook.png" title="OpenSpeedShop">
        <section ref="../doc/index.html" title="OpenSpeedShop Documentation">
            <keyword ref="../doc/index.html">Main Page</keyword>
