...
FPE_TracingWizardPanel::FPE_TracingWizardPanel(PanelContainer *pc, const char *n) : Panel(pc, n)
{
  ...
  frameLayout = new QHBoxLayout( getBaseWidgetFrame(), 1, 2, getName() );
    ...
    if ( !name )
	setName( "FPE_TracingWizardPanel" );
 ...
 *  language.
 */
void FPE_TracingWizardPanel::languageChange()
{
    setCaption( tr( "FPE_TracingWizardPanel" ) );
    vWizardTitleLabel->setText( tr( "<h1>FPE Tracing Wizard</h1>" ) );
    vWizardDescription->setText( tr( "Insert the description of a FPE Tracing Experiment." ) );
    vpage0HideWizardCheckBox->setText( tr( "Hide FPE Tracing Wizard next time FPE Tracing Experiment is selected.\n"
...
"Summare the FPE Tracing Experiment settings</p>" ) );
    ...
    eWizardTitleLabel->setText( tr( "<h1>FPE Tracing Wizard</h1>" ) );
...
"The usertime experiment should incur a program execution slowdown of no more than 15%. Data from a usertime experiment is statistical in nature and shows some variance from run to run." ) );
    epage0HideWizardCheckBox->setText( tr( "Hide FPE Tracing Wizard next time FPE Tracing Experiment is selected.\n"
"(Note: You can change this back by going to the FPE Tracing local menu.)" ) );
...
/*! Unimplemented */
void FPE_TracingWizardPanel::epage0HideWizardCheckBoxSelected()
{
    qWarning( "FPE_TracingWizardPanel::epage0HideWizardCheckBoxSelected(): Not implemented yet" );
}

/*! Goes way back and raises the Intro Wizard. */
void FPE_TracingWizardPanel::epage0StartButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::epage0StartButtonSelected(): Not implemented yet" );
...
void FPE_TracingWizardPanel::epage0NextButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::epage0NextButtonSelected(): Not implemented yet" );
...
void FPE_TracingWizardPanel::epage1BackButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::epage1BackButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackEPage0);
}

/*! Takes you to the next page. */
void FPE_TracingWizardPanel::epage1NextButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::epage1NextButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackEPage2);
}

void FPE_TracingWizardPanel::epage1ResetButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::epage1ResetButtonSelected(): Not implemented yet" );
}

void FPE_TracingWizardPanel::epage1SampleRateTextSelected()
{
    qWarning( "FPE_TracingWizardPanel::epage1SampleRateTextSelected(): Not implemented yet" );
}

/*! Takes you to the previous page. */
void FPE_TracingWizardPanel::epage2BackButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::epage2BackButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackEPage1);
}

void FPE_TracingWizardPanel::epage2FinishButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::epage2FinishButtonSelected(): Not implemented yet" );
...
{
    qWarning( "FPE_TracingWizardPanel::wizardModeSelected(): Not implemented yet" );
...
void FPE_TracingWizardPanel::vpage0HideWizardCheckBoxSelected()
{
    qWarning( "FPE_TracingWizardPanel::vpage0HideWizardCheckBoxSelected(): Not implemented yet" );
}

/*! Takes you to the next page. */
void FPE_TracingWizardPanel::vpage0NextButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::vpage0NextButtonSelected(): Not implemented yet" );
...
void FPE_TracingWizardPanel::vpage0StartButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::vpage0StartButtonSelected(): Not implemented yet" );
...
/*! Takes you to the previous page. */
void FPE_TracingWizardPanel::vpage1BackButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::vpage1BackButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackVPage0);
}

/*! Takes you to the next page. */
void FPE_TracingWizardPanel::vpage1NextButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::vpage1NextButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackVPage2);
}

void FPE_TracingWizardPanel::vpage1ResetButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::vpage1ResetButtonSelected(): Not implemented yet" );
}

/*! Takes you to the previous page. */
void FPE_TracingWizardPanel::vpage2BackButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::vpage2BackButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackVPage1);
}

void FPE_TracingWizardPanel::vpage2FinishButtonSelected()
{
    qWarning( "FPE_TracingWizardPanel::vpage2FinishButtonSelected(): Not implemented yet" );
     panelContainer->_masterPC->dl_create_and_add_panel("FPE Tracing", panelContainer);
}

void FPE_TracingWizardPanel::vpage1SampleRateTextSelected()
{
    qWarning( "FPE_TracingWizardPanel::vpage1SampleRateTextSelected(): Not implemented yet" );
}
