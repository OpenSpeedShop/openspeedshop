 ...
 *  language.
 */
void UserTimeWizardPanel::languageChange()
{
    setCaption( tr( "UserTimeWizardPanel" ) );
...
/*! Unimplemented */
void UserTimeWizardPanel::epage0HideWizardCheckBoxSelected()
{
    qWarning( "UserTimeWizardPanel::epage0HideWizardCheckBoxSelected(): Not implemented yet" );
}

/*! Goes way back and raises the Intro Wizard. */
void UserTimeWizardPanel::epage0StartButtonSelected()
{
    qWarning( "UserTimeWizardPanel::epage0StartButtonSelected(): Not implemented yet" );
...
void UserTimeWizardPanel::epage0NextButtonSelected()
{
    qWarning( "UserTimeWizardPanel::epage0NextButtonSelected(): Not implemented yet" );
...
void UserTimeWizardPanel::epage1BackButtonSelected()
{
    qWarning( "UserTimeWizardPanel::epage1BackButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackEPage0);
}

/*! Takes you to the next page. */
void UserTimeWizardPanel::epage1NextButtonSelected()
{
    qWarning( "UserTimeWizardPanel::epage1NextButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackEPage2);
}

void UserTimeWizardPanel::epage1ResetButtonSelected()
{
    qWarning( "UserTimeWizardPanel::epage1ResetButtonSelected(): Not implemented yet" );
}

void UserTimeWizardPanel::epage1SampleRateTextSelected()
{
    qWarning( "UserTimeWizardPanel::epage1SampleRateTextSelected(): Not implemented yet" );
}

/*! Takes you to the previous page. */
void UserTimeWizardPanel::epage2BackButtonSelected()
{
    qWarning( "UserTimeWizardPanel::epage2BackButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackEPage1);
}
...
{
    qWarning( "UserTimeWizardPanel::wizardModeSelected(): Not implemented yet" );
...
void UserTimeWizardPanel::vpage0HideWizardCheckBoxSelected()
{
    qWarning( "UserTimeWizardPanel::vpage0HideWizardCheckBoxSelected(): Not implemented yet" );
}

/*! Takes you to the next page. */
void UserTimeWizardPanel::vpage0NextButtonSelected()
{
    qWarning( "UserTimeWizardPanel::vpage0NextButtonSelected(): Not implemented yet" );
...
void UserTimeWizardPanel::vpage0StartButtonSelected()
{
    qWarning( "UserTimeWizardPanel::vpage0StartButtonSelected(): Not implemented yet" );
...
/*! Takes you to the previous page. */
void UserTimeWizardPanel::vpage1BackButtonSelected()
{
    qWarning( "UserTimeWizardPanel::vpage1BackButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackVPage0);
}

/*! Takes you to the next page. */
void UserTimeWizardPanel::vpage1NextButtonSelected()
{
    qWarning( "UserTimeWizardPanel::vpage1NextButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackVPage2);
}

void UserTimeWizardPanel::vpage1ResetButtonSelected()
{
    qWarning( "UserTimeWizardPanel::vpage1ResetButtonSelected(): Not implemented yet" );
}

/*! Takes you to the previous page. */
void UserTimeWizardPanel::vpage2BackButtonSelected()
{
    qWarning( "UserTimeWizardPanel::vpage2BackButtonSelected(): Not implemented yet" );
    userTimeWizardStack->raiseWidget(WStackVPage1);
}
...
{
    qWarning( "UserTimeWizardPanel::vpage1SampleRateTextSelected(): Not implemented yet" );
}
