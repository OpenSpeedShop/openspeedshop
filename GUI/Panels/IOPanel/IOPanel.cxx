...
/*! IOPanel Class is intended to be used as a starting point to create
    ...
    An exmple would be to cd to this IOPanel directory and issue the
    following command:
...
{ // Unused... Here for completeness...
  fprintf(stderr, "IOPanel::IOPanel() should not be called.\n");
  fprintf(stderr, "see: IOPanel::IOPanel(PanelContainer *pc, const char *n)\n");
}
...
*/
  ...
  baseWidgetFrame->setCaption("IOPanelBaseWidget");
}
...
{
  dprintf("IOPanel::menu() requested.\n");
...
IOPanel::saveAs()
{
  dprintf("IOPanel::saveAs() requested.\n");
}
 ...
 */
int 
IOPanel::listener(char *msg)
{
  dprintf("IOPanel::listener() requested.\n");
