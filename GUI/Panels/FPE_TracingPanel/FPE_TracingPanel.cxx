...
/*! FPE_TracingPanel Class is intended to be used as a starting point to create
    ...
    An exmple would be to cd to this FPE_TracingPanel directory and issue the
    following command:
...
{ // Unused... Here for completeness...
  fprintf(stderr, "FPE_TracingPanel::FPE_TracingPanel() should not be called.\n");
  fprintf(stderr, "see: FPE_TracingPanel::FPE_TracingPanel(PanelContainer *pc, const char *n)\n");
}
...
*/
  ...
  baseWidgetFrame->setCaption("FPE_TracingPanelBaseWidget");
}
...
{
  dprintf("FPE_TracingPanel::menu() requested.\n");
...
{
  dprintf("FPE_TracingPanel::saveAs() requested.\n");
}
