...
#define PANEL_CLASS_NAME ToolbarPanel   // Change the value of the define
                                         // to the name of your new class.
//! ToolbarPanel Class
/*! ToolbarPanel Class is intended to be used as a starting point to create
    ...
    An exmple would be to cd to this ToolbarPanel directory and issue the
    following command:
...
class ToolbarPanel  : public Panel
{
  ...
  Q_OBJECT
public:
  //! ToolbarPanel() - A default constructor the the Panel Class.
  ToolbarPanel();  // Default construct

  //! ToolbarPanel(PanelContainer *pc, const char *name)
     ...
     */
  ToolbarPanel(PanelContainer *pc, const char *n); // Active constructor

  //! ~ToolbarPanel() - The default destructor.
  ~ToolbarPanel();  // Active destructor
