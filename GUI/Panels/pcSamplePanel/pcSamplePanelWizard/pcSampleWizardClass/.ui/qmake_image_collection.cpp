/****************************************************************************
** Image collection for project 'pcsample'.
**
...
**
** Created: Fri Apr 16 07:11:08 2004
...
class MimeSourceFactory_pcsample : public QMimeSourceFactory
{
public:
    MimeSourceFactory_pcsample() {}
    ~MimeSourceFactory_pcsample() {}
...
void qInitImages_pcsample()
{
    if ( !factory ) {
	factory = new MimeSourceFactory_pcsample;
	QMimeSourceFactory::defaultFactory()->addFactory( factory );
    }
}

void qCleanupImages_pcsample()
{
    if ( factory ) {
...
class StaticInitImages_pcsample
{
public:
    StaticInitImages_pcsample() { qInitImages_pcsample(); }
#if defined(Q_OS_SCO) || defined(Q_OS_UNIXWARE)
    ~StaticInitImages_pcsample() { }
#else
    ~StaticInitImages_pcsample() { qCleanupImages_pcsample(); }
#endif
};

static StaticInitImages_pcsample staticImages;
