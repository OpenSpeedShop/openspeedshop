...
#define PANEL_CLASS_NAME pcSampleWizard   // Change the value of the define
                                         // to the name of your new class.
//! pcSampleWizard Class
/*! pcSampleWizard Class is intended to be used as a starting point to create
    ...
    An exmple would be to cd to this pcSampleWizard directory and issue the
    following command:
    ...
    panels.
*/
class pcSampleWizard  : public Panel
{
  //! Q_OBJECT is needed as there are slots defined for the class
  Q_OBJECT
public:
  //! pcSampleWizard() - A default constructor the the Panel Class.
  pcSampleWizard();  // Default construct

  //! pcSampleWizard(PanelContainer *pc, const char *name)
     ...
     */
  pcSampleWizard(PanelContainer *pc, const char *n); // Active constructor

  //! ~pcSampleWizard() - The default destructor.
  ~pcSampleWizard();  // Active destructor
