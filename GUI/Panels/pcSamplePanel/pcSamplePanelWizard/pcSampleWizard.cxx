#include "pcSampleWizard.hxx"   // Change this to your new class header file name
 ...
 */
pcSampleWizard::pcSampleWizard(PanelContainer *pc, const char *n) : Panel(pc, n)
{
  printf("pcSampleWizard::pcSampleWizard() constructor called\n");
...
pcSampleWizard::~pcSampleWizard()
{
  printf("  pcSampleWizard::~pcSampleWizard() destructor called\n");
...
bool
pcSampleWizard::menu(QPopupMenu* contextMenu)
{
  dprintf("pcSampleWizard::menu() requested.\n");
...
pcSampleWizard::save()
{
  dprintf("pcSampleWizard::save() requested.\n");
}
 ...
 */
void 
pcSampleWizard::saveAs()
{
  dprintf("pcSampleWizard::saveAs() requested.\n");
}

//! This function listens for messages.
int 
pcSampleWizard::listener(char *msg)
{
  dprintf("pcSampleWizard::listener() requested.\n");
...
int 
pcSampleWizard::broadcast(char *msg)
{
  dprintf("pcSampleWizard::broadcast() requested.\n");
  return 0;
}

#ifdef PULL
void
pcSampleWizard::page1NextSelected()
{
...
printf("GUI ONLY?: get a list of executables to attach to.\n");
    pcSampleWizardStack->raiseWidget(1);
...
void
pcSampleWizard::page2BackSelected()
{
  pcSampleWizardStack->raiseWidget(0);
}

void
pcSampleWizard::page2ResetSelected()
{
  printf("Reset selected.\n");
}

void
pcSampleWizard::page2NextSelected()
{
QString fn = QString::null;
...
sprintf(buffer, "<p align=\"left\">You've selected a pc Sampling experiment for executable \"%s\" to be run on host \"%s\".  Futher you've chosed a sample rate of \"%s\" milliseconds.<br><br>To complete the experiment setup select the \"Finish\" button.<br><br>Upon selection of the \"Finish\" button an experiment \"Control\" panel will be raised to allow you to futher control the experiment.<br><br>Press the \"Back\" button to go back to the previous page.</p>", fn.ascii(), "localhost", pcSampleRateText->text().ascii() );
  ...
  pcSampleWizardStack->raiseWidget(2);
}

void
pcSampleWizard::page3BackSelected()
{
  pcSampleWizardStack->raiseWidget(1);
}

void
pcSampleWizard::setLoadExecutableRB()
{
...
void
pcSampleWizard::setAttachProcessRB()
{
...
void
pcSampleWizard::hideWizardCheck()
{
...
void
pcSampleWizard::page3FinishSelected()
{
...
void pcSampleWizard::wizardModeSelected()
{
  QWidget *raisedWidget = pcSampleWizardStack->visibleWidget();
...
} else if( raisedWidget == WStackEPage2 )
{
  ...
  if( wizardMode->isOn() )
  {
    ...
    {
        printf("WStackEPage0\n");
        pcSampleWizardStack->raiseWidget(WStackVPage0);
    } else if( raisedWidget == WStackEPage1 )
    {
        printf("WStackEPage1\n");
        pcSampleWizardStack->raiseWidget(WStackVPage1);
    } else if( raisedWidget == WStackEPage2 )
    {
        printf("WStackEPage2\n");
        pcSampleWizardStack->raiseWidget(WStackVPage2);
    } else
    {
  ...
  } else
  {
    ...
    {
        printf("WStackVPage0\n");
        pcSampleWizardStack->raiseWidget(WStackEPage0);
    } else if( raisedWidget ==  WStackVPage1 )
    {
        printf("WStackVPage1\n");
        pcSampleWizardStack->raiseWidget(WStackEPage1);
    } else if( raisedWidget == WStackVPage2 )
    {
        printf("WStackVPage2\n");
        pcSampleWizardStack->raiseWidget(WStackEPage2);
    } else
    {
...
void pcSampleWizard::epage0HideWizardCheckBoxSelected()
{
}

#include "ladDialog.hxx"
void pcSampleWizard::epage0NextButtonSelected()
{
printf("epage0NextButtonSelected() \n");
    pcSampleWizardStack->raiseWidget(WStackEPage1);
}

void pcSampleWizard::epage0StartButtonSelected()
{
...
void pcSampleWizard::epage1BackButtonSelected()
{
printf("epage1BackButtonSelected() \n");
    pcSampleWizardStack->raiseWidget(WStackEPage0);
}

void pcSampleWizard::epage1NextButtonSelected()
{
...
void pcSampleWizard::epage1ResetButtonSelected()
{
printf("epage1ResetButtonSelected() \n");
}

void pcSampleWizard::epage2BackButtonSelected()
{
printf("epage2BackButtonSelected() \n");
    pcSampleWizardStack->raiseWidget(WStackEPage1);
}

void pcSampleWizard::epage2FinishButtonSelected()
{
...
void pcSampleWizard::vpage0HideWizardCheckBoxSelected()
{
printf("vpage1HideWizardCheckBoxSelected() \n");
}

void pcSampleWizard::vpage0NextButtonSelected()
{
...
void pcSampleWizard::vpage0StartButtonSelected()
{
...
void pcSampleWizard::vpage1pcSampleRateTextReturnPressed()
{
printf("vpage1pcSampleRateTextReturnPressed() \n");
}

void pcSampleWizard::epage1pcSampleRateTextReturnPressed()
{
printf("epage1pcSampleRateTextReturnPressed() \n");
}

void pcSampleWizard::vpage1BackButtonSelected()
{
printf("vpage1BackButtonSelected() \n");
    pcSampleWizardStack->raiseWidget(WStackVPage0);
}

void pcSampleWizard::vpage1NextButtonSelected()
{
...
void pcSampleWizard::vpage1ResetButtonSelected()
{
printf("vpage1ResetButtonSelected() \n");
}

void pcSampleWizard::vpage2BackButtonSelected()
{
printf("vpage2BackButtonSelected() \n");
    pcSampleWizardStack->raiseWidget(WStackVPage1);
}

void pcSampleWizard::vpage2FinishButtonSelected()
{
