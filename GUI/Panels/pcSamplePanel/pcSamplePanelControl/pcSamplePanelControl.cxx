#include "pcSamplePanelControl.hxx"   // Change this to your new class header file name
...
pcSamplePanelControl::pcSamplePanelControl()
 ...
 */
pcSamplePanelControl::pcSamplePanelControl(PanelContainer *pc, const char *n) : Panel(pc, n)
{
  printf("pcSamplePanelControl::pcSamplePanelControl() constructor called\n");
...
pcSamplePanelControl::~pcSamplePanelControl()
{
  printf("  pcSamplePanelControl::~pcSamplePanelControl() destructor called\n");
  delete frameLayout;
...
bool
pcSamplePanelControl::menu(QPopupMenu* contextMenu)
{
  printf("pcSamplePanelControl::menu() requested.\n");
...
void
pcSamplePanelControl::openNewSelected()
{
  printf("pcSamplePanel::openNewSelected()\n");
}   

void 
pcSamplePanelControl::saveAsSelected()
{
  printf("pcSamplePanelControl::saveAsSelected() requested.\n");
}
 ...
 */
void 
pcSamplePanelControl::save()
{
  dprintf("pcSamplePanelControl::save() requested.\n");
}
 ...
 */
void 
pcSamplePanelControl::saveAs()
{
  printf("pcSamplePanelControl::saveAs() requested.\n");
}

//! This function listens for messages.
int 
pcSamplePanelControl::listener(char *msg)
{
  dprintf("pcSamplePanelControl::listener() requested.\n");
...
int 
pcSamplePanelControl::broadcast(char *msg)
{
  dprintf("pcSamplePanelControl::broadcast() requested.\n");
  return 0;
}


void 
pcSamplePanelControl::attachButtonSlot()
{
  printf("Attach\n");
}
...
#ifdef PULL
void 
pcSamplePanelControl::enterEvent(QEvent *)
{
  printf("detach enterEvent\n");
}

void 
pcSamplePanelControl::leaveEvent(QEvent *)
{
...
void 
pcSamplePanelControl::detachButtonSlot()
{
  printf("Detach\n");
}
...
void 
pcSamplePanelControl::runButtonSlot()
{
...
void 
pcSamplePanelControl::pauseButtonSlot()
{
...
void 
pcSamplePanelControl::continueButtonSlot()
{
...
void 
pcSamplePanelControl::updateButtonSlot()
{
...
void 
pcSamplePanelControl::interruptButtonSlot()
{
...
void 
pcSamplePanelControl::terminateButtonSlot()
{
 ...
 */
void
pcSamplePanelControl::languageChange()
{
