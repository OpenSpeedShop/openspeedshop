...
/**
 * Conversion from CBTF_Protocol_AddressRange to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_AddressRange into a std::string.
 *
...
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_AddressRange& range
    )
{
...
/**
 * Conversion from CBTF_Protocol_AddressBitmap to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_AddressBitmap into
...
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_AddressBitmap& bitmap
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_Blob to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_Blob into a std::string.
...
/**
 * Conversion from CBTF_Protocol_Collector to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_Collector into a std::string.
 ...
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_Collector& collector
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_FileName to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_FileName into a std::string.
 * Simply returns the string containing the textual representation of the
 ...
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_FileName& file
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_FunctionEntry to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_FunctionEntry into a
 * std::string. ...
 *
 ...
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_FunctionEntry& function
    )
{
    std::stringstream output;
    output << "    ";
...
/**
 * Conversion from CBTF_Protocol_JobEntry to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_JobEntry into a std::string. ...
 ...
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_JobEntry& entry
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_Job to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_Job into a std::string. Simply
...
/**
 * Conversion from CBTF_Protocol_StatementEntry to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_StatementEntry into a
 * std::string. ...
 *
 ...
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_StatementEntry& statement
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_ThreadName to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_ThreadName into a std::string.
 * Simply returns the string containing the textual representation of the
...
/**
 * Conversion from CBTF_Protocol_ThreadNameGroup to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_ThreadNameGroup into a std::
 ...
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_ThreadNameGroup& threads
    )
{
    std::stringstream output;
    output << "    { ";
...
/**
 * Conversion from CBTF_Protocol_ThreadState to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_ThreadState into a std::string.
 ...
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_ThreadState& state
    )
{
    switch(state) {
    case Disconnected:
...
/**
 * Conversion from CBTF_Protocol_AttachToThreads to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_AttachToThreads message
 * into a std::string.
 *
 ...
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_AttachToThreads& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_AttachedToThreads to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_AttachedToThreads message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_AttachedToThreads& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_ChangeThreadsState to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_ChangeThreadsState message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_ChangeThreadsState& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_CreateProcess to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_CreateProcess message into a
 * std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_CreateProcess& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_CreatedProcess to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_CreatedProcess message into a
 * std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_CreatedProcess& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_DetachFromThreads to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_DetachFromThreads message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_DetachFromThreads& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_ExecuteNow to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_ExecuteNow message into a
 * std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_ExecuteNow& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_ExecuteAtEntryOrExit to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_ExecuteAtEntryOrExit message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_ExecuteAtEntryOrExit& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_ExecuteInPlaceOf to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_ExecuteInPlaceOf message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_ExecuteInPlaceOf& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_GetGlobalInteger to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_GetGlobalInteger message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_GetGlobalInteger& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_GetGlobalString to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_GetGlobalString message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_GetGlobalString& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_GetMPICHProcTable to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_GetMPICHProcTable message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_GetMPICHProcTable& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_GlobalIntegerValue to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_GlobalIntegerValue message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_GlobalIntegerValue& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_GlobalJobValue to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_GlobalJobValue message into a
 * std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_GlobalJobValue& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_GlobalStringValue to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_GlobalStringValue message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_GlobalStringValue& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_Instrumented to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_Instrumented message into a
 * std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_Instrumented& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_LoadedLinkedObject to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_LoadedLinkedObject message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
...
/**
 * Conversion from CBTF_Protocol_LinkedObjectGroup to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_LinkedObjectGroup message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
...
{
    std::stringstream output;
    output << "linkedObjectGroup(" << std::endl
	   << toString(message.thread) << "," << std::endl
#if 0
	   << "    " << Time(message.time) << "," << std::endl
	   << "    " << toString(message.range) << "," << std::endl
...
/**
 * Conversion from CBTF_Protocol_ReportError to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_ReportError message into a
 * std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_ReportError& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_SetGlobalInteger to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_SetGlobalInteger message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_SetGlobalInteger& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_StdErr to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_StdErr message into a
 * std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_StdErr& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_StdIn to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_StdIn message into a
 * std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_StdIn& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_StdOut to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_StdOut message into a
 * std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_StdOut& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_StopAtEntryOrExit to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_StopAtEntryOrExit message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_StopAtEntryOrExit& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_SymbolTable to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_SymbolTable message into a
 ...
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_SymbolTable& message,
    const bool& verbose
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_ThreadsStateChanged to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_ThreadsStateChanged message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_ThreadsStateChanged& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_Uninstrument to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_Uninstrument message into a
 * std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
 */
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_Uninstrument& message
    )
{
    std::stringstream output;
...
/**
 * Conversion from CBTF_Protocol_UnloadedLinkedObject to std::string.
 *
 * Returns the conversion of an CBTF_Protocol_UnloadedLinkedObject message
 * into a std::string.
 *
 * @param message    Message to be converted.
 * @return           String conversion of that message.
...
std::string OpenSpeedShop::Framework::toString(
    const CBTF_Protocol_MPIStartup& message
    )
{
    std::stringstream output;
