...
/** @file
 *
 * Definition of the Watcher_OpenSS_Path_From_Pid() function for offline collectors.
 *
 */
...
bool_t
Watcher_OpenSS_Path_From_Pid(char *exe_path)
{
    char name[PATH_MAX];
...
bool_t
Watcher_OpenSS_Path_From_Pid(char *exe_path, pid_t pidID)
{
    char name[PATH_MAX];
    char symlink[PATH_MAX];

    pid_t cur_pid = pidID; // This had better be our mutatee.
