...
#ifndef MRDIFFUSEAREASPHERELUMINAIRE_H
#define MRDIFFUSEAREASPHERELUMINAIRE_H


#include <mrSphere.h>


class mrDiffuseAreaSphereLuminaire : public mrSphere {
public:
 ...
 mrDiffuseAreaSphereLuminaire(const ggPoint3& cen, double rad,
                       ggSpectrum& emit)
      : mrSphere(cen, rad) {kEmit = emit;}

 

  protected:
     mrDiffuseAreaSphereLuminaire() { }
     ggSpectrum kEmit;
};
