...
//
#ifndef GGJRSAMPLE3_H
#define GGJRSAMPLE3_H

#include <ggSample3.h>

class ggJRSample3 : public ggSample3 {
public:
				// Constructors
  ggJRSample3();
  ggJRSample3(const int &, const int &, const int& );
  ~ggJRSample3();
...
protected:
  int nx, ny, nz;		// number of samples along each dimension
  int xperm, yperm, zperm;	// samples perpendicular to each dimension
