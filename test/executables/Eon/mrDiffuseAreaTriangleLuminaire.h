...
#ifndef MRDIFFUSEAREATRIANGLELUMINAIRE_H
#define MRDIFFUSEAREATRIANGLELUMINAIRE_H

#include <mrFastTriangle.h>

class mrDiffuseAreaTriangleLuminaire : public mrFastTriangle {
...
mrDiffuseAreaTriangleLuminaire(const ggPoint3 pt0,
              const ggPoint3 pt1,
              const ggPoint3 pt2,
              const ggSpectrum& emit);
 protected:
  
  mrDiffuseAreaTriangleLuminaire() { }  
  ggONB3 uvw;
  double area;
  ggPoint3 centroid;
  ggSpectrum kEmit;
