...
#ifndef MRPHONGAREAYZRECTANGLELUMINAIRE_H
#define MRPHONGAREAYZRECTANGLELUMINAIRE_H
...
class mrPhongAreaYZRectangleLuminaire : public mrYZRectangle {
public:
...
mrPhongAreaYZRectangleLuminaire(double x, 
               double ymin,
               double ymax,
               double zmin,
               double zmax,
               const ggSpectrum& emit,
               double expo) : mrYZRectangle(x, ymin, ymax,
                         zmin, zmax) {
                                              kEmit = emit;
                                              phongN = expo; }

  protected:
      mrPhongAreaYZRectangleLuminaire() {}
      double phongN;
      ggSpectrum kEmit;
};
