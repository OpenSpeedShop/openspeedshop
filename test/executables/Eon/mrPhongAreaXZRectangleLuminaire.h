...
#ifndef MRPHONGAREAXZRECTANGLELUMINAIRE_H
#define MRPHONGAREAXZRECTANGLELUMINAIRE_H


#include <mrXZRectangle.h>

// an axis-aligned rectangle parallel to the XZ plane

class mrPhongAreaXZRectangleLuminaire : public mrXZRectangle {
public:
...
mrPhongAreaXZRectangleLuminaire(double xmin, 
               double xmax,
               double y,
               double zmin,
               double zmax,
               const ggSpectrum& emit,
               double expo) : mrXZRectangle(xmin, xmax,
                         y, zmin, zmax) {
                                          kEmit = emit; phongN = expo; }

  protected:
      mrPhongAreaXZRectangleLuminaire() {}
      double phongN;
      ggSpectrum kEmit;
};
