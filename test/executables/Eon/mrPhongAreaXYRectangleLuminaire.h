...
#ifndef MRPHONGAREAXYRECTANGLELUMINAIRE_H
#define MRPHONGAREAXYRECTANGLELUMINAIRE_H
...
class mrPhongAreaXYRectangleLuminaire : public mrXYRectangle {
public:
...
mrPhongAreaXYRectangleLuminaire(double xmin, 
               double xmax,
               double ymin,
               double ymax,
               double zval,
               const ggSpectrum& emit, double exp) : mrXYRectangle(xmin, xmax,
                         ymin, ymax, zval) {
                                              kEmit = emit; phongN = exp; }

  protected:
      mrPhongAreaXYRectangleLuminaire() {}
      double phongN;
      ggSpectrum kEmit;
};
