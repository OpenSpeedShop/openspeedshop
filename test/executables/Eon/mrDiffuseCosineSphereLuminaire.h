...
#ifndef MRDIFFUSECOSINELUMINAIRE_H
#define MRDIFFUSECOSINELUMINAIRE_H


#include <mrDiffuseAreaSphereLuminaire.h>


class mrDiffuseCosineSphereLuminaire :
...
public:
 ...
 mrDiffuseCosineSphereLuminaire(const ggPoint3 cen, double rad,
                       ggSpectrum emit)
  ...
  protected:
     mrDiffuseCosineSphereLuminaire() { }
};
