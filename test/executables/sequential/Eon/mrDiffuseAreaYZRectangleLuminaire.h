...
#ifndef MRDIFFUSEAREAYZRECTANGLELUMINAIRE_H
#define MRDIFFUSEAREAYZRECTANGLELUMINAIRE_H


#include <mrYZRectangle.h>

// an axis-aligned rectangle parallel to the YZ plane

class mrDiffuseAreaYZRectangleLuminaire : public mrYZRectangle {
public:
...
mrDiffuseAreaYZRectangleLuminaire(double x, 
               double ymin,
               double ymax,
               double zmin,
               double zmax,
               const ggSpectrum& emit) : mrYZRectangle(x, ymin, ymax,
                         zmin, zmax) {
                                              kEmit = emit; }

  protected:
      mrDiffuseAreaYZRectangleLuminaire() {}
      ggSpectrum kEmit;
};
