...
#ifndef MRDIFFUSECOSINEZCYLINDERLUMINAIRE_H
#define MRDIFFUSECOSINEZCYLINDERLUMINAIRE_H


// an axis-aligned cylinder parallel to the Z axis
#include <mrDiffuseAreaZCylinderLuminaire.h>

class mrDiffuseCosineZCylinderLuminaire :
...
// cylinder of radius r on z axis in z range [0,h]
 mrDiffuseCosineZCylinderLuminaire(double radius, double height,
                                  const ggSpectrum& s) :
             mrDiffuseAreaZCylinderLuminaire(radius, height, s) {}


  protected:
     mrDiffuseCosineZCylinderLuminaire() { }
