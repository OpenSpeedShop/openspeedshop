...
#ifndef MRDIFFUSEAREAXZRECTANGLELUMINAIRE_H
#define MRDIFFUSEAREAXZRECTANGLELUMINAIRE_H
...
class mrDiffuseAreaXZRectangleLuminaire : public mrXZRectangle {
public:
...
mrDiffuseAreaXZRectangleLuminaire(double xmin, 
               double xmax,
               double y,
               double zmin,
               double zmax,
               const ggSpectrum& emit) : mrXZRectangle(xmin, xmax,
                         y, zmin, zmax) {
                                              kEmit = emit; }

  protected:
      mrDiffuseAreaXZRectangleLuminaire() {}
      ggSpectrum kEmit;
};
