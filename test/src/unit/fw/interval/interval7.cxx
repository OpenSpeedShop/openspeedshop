...
/* This is a negative test for Interval::doesIntersect(interval &).  It verifies
that doesIntersect returns false for an interval that does not intersect another interval.
*/
...
int main(){
	...
	if (testwxRange.doesIntersect(testyzRange)){
		cout << "FAIL" << endl;
	}
	else
	{
