...
/* This is a test for Interval::doesContain(interval &).  It verifies
that doesContain returns true for an interval that is within the range.
*/
...
int main(){
	...
	AddressRange testxyRange(testxAddress, testyAddress);
	AddressRange testwzRange(testwAddress, testzAddress);
	if (testwzRange.doesContain(testxyRange)){
		cout << "PASS" << endl;
	}
	else
	{
