...
#ifndef PREPARETORERUNOBJECT_H
#define PREPARETORERUNOBJECT_H

#include "MessageObject.hxx"

//! The message object for update data message of an experiment
class PrepareToRerunObject : public MessageObject
{
public:
    //! Constructor for creating source message.
    PrepareToRerunObject(void *expr, int  expID, QString experiment_name, bool raiseFLAG, bool forceFLAG);

    //! Destructor
    ~PrepareToRerunObject();
    ...
    //! Flag to determine if the reciever should force the update
    //! when handling this message.
    bool forceFLAG;
};
#endif // PREPARETORERUNOBJECT_H
