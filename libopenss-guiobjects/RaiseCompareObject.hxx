...
#ifndef RAISECOMPAREOBJECT_H
#define RAISECOMPAREOBJECT_H

#include "MessageObject.hxx"

//! The message object for update data message of an experiment
class RaiseCompareObject : public MessageObject
{
public:
    //! Constructor for creating source message.
    RaiseCompareObject(int  expID, bool raiseFLAG);
