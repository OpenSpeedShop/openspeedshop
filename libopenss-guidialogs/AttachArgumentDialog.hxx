...
#ifndef ATTACHARGUMENTDIALOG_H
#define ATTACHARGUMENTDIALOG_H
...
class AttachArgumentDialog : public QFileDialog
{
    Q_OBJECT

public:
    AttachArgumentDialog( QWidget* parent = 0, const char* name = 0, bool modal = FALSE, WFlags fl = 0 );
    ~AttachArgumentDialog();
