...
#include "AttachArgumentDialog.hxx"
...
AttachArgumentDialog::AttachArgumentDialog( QWidget* parent, const char* name, bool modal, WFlags fl )
    : QFileDialog( parent, name, modal )
{
  nprintf(DEBUG_CONST_DESTRUCT) ("AttachArgumentDialog::AttachArgumentDialog() constructor called.\n");
#ifdef DEBUG_ARG 
  printf("AttachArgumentDialog::AttachArgumentDialog() constructor called.\n");
#endif
  ...
  plo = NULL;
  incExcList.clear();
  if ( !name ) setName( "AttachArgumentDialog" );
  ...
  AttachArgDialog = new QVBoxLayout( topFrame, 11, 6, "AttachArgDialog"); 

  QHBoxLayout *headerLayout = new QHBoxLayout( AttachArgDialog, 6, "headerLayout" );
  ...
  AttachArgDialog->addWidget( availableProcessListView );


  mpiCB = new QCheckBox( topFrame, "mpiCB");
  AttachArgDialog->addWidget( mpiCB );
...
#ifdef DEBUG_ARG 
  printf("AttachArgumentDialog::AttachArgumentDialog() destructor called.\n");
#endif
}
 ...
 */
AttachArgumentDialog::~AttachArgumentDialog()
{
  // no need to delete child widgets, Qt does it all for us
  nprintf(DEBUG_CONST_DESTRUCT) ("AttachArgumentDialog::AttachArgumentDialog() destructor called.\n");
#ifdef DEBUG_ARG 
  printf("AttachArgumentDialog::AttachArgumentDialog() destructor called.\n");
#endif
}
 ...
 *  language.
 */
void AttachArgumentDialog::languageChange()
{
  setCaption( tr( "AttachArgumentDialog" ) );
...
// QString
QStringList *
AttachArgumentDialog::selectedProcesses(bool *mpiFLAG)
{
//  QString ret_value = attachHostComboBox->currentText();

#ifdef DEBUG_ARG 
// printf("AttachArgumentDialog::selectedProcesses() entered\n");
#endif
...
void
AttachArgumentDialog::updateAttachableProcessList()
{
...
void AttachArgumentDialog::attachHostComboBoxActivated()
{
#ifdef DEBUG_ARG 
...
void AttachArgumentDialog::buttonFilterSelected()
{
#ifdef DEBUG_ARG 
...
void AttachArgumentDialog::accept()
{
#ifdef DEBUG_ARG 
// printf("AttachArgumentDialog::accept() called.\n");
#endif
}

void AttachArgumentDialog::ok_accept()
{
#ifdef DEBUG_ARG 
// printf("AttachArgumentDialog::ok_accept() called.\n");
#endif
  QDialog::accept();
}
...
bool
AttachArgumentDialog::includeOrExcludeThisItem(const char *process_name)
{
#ifdef DEBUG_ARG 
...
void
AttachArgumentDialog::exclusionRBSelected()
{
  exclusionRB->setChecked(TRUE);
...
void
AttachArgumentDialog::inclusionRBSelected()
{
...
void
AttachArgumentDialog::addSelected()
{
#ifdef DEBUG_ARG 
// printf("addSelected() \n");
#endif
...
void
AttachArgumentDialog::removeSelected()
{
#ifdef DEBUG_ARG 
...
void
AttachArgumentDialog::readFilterList()
{
#ifdef DEBUG_ARG 
...
void
AttachArgumentDialog::saveSelected()
{
#ifdef DEBUG_ARG 
...
void
AttachArgumentDialog::updateFilterList()
{
