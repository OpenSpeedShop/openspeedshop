...
#ifndef ATTACHMPPROGRAMDIALOG_H
#define ATTACHMPPROGRAMDIALOG_H
...
class AttachMPProgramDialog : public QFileDialog
{
    Q_OBJECT

public:
//    AttachMPProgramDialog( QWidget* parent = 0, const char* name = 0, bool modal = FALSE, WFlags fl = 0 );
    AttachMPProgramDialog( QWidget* parent = 0, const char* name = 0, bool modal = FALSE);
    ~AttachMPProgramDialog();
