...
#ifndef ATTACHMPPROCESSDIALOG_H
#define ATTACHMPPROCESSDIALOG_H
...
class AttachMPProcessDialog : public QDialog
{
    Q_OBJECT

public:
    AttachMPProcessDialog( QWidget* parent = 0, const char* name = 0, bool modal = FALSE, WFlags fl = 0 );
    ~AttachMPProcessDialog();
    ...
    QSplitter *attachMPProcessSplitter;
...
protected:
    QVBoxLayout* AttachMPProcessDialogLayout;
