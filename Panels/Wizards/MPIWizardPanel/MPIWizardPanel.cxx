...
//        printf("Warning: No attach or load paramaters available.\n");
      ...
      if( lao != NULL )
      {
        if( !p )
        {
          ...
          p = getPanelContainer()->getMasterPC()->dl_create_and_add_panel("MPI", getPanelContainer(), (void *)argument);
        }
...
"You've selected a MPI experiment for executable \"%s\" to be run on host \"%s\".  Futher you've chosed a sample rate of \"%d\".<br><br></p>" ) );
