...
"You've selected a FPE Tracing experiment for executable \"%s\" to be run on host \"%s\".  Furthermore, you've chosen a sample rate of \"%d\".<br><br></p>" ) );
