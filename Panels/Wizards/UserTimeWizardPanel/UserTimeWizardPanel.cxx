...
"You've selected a User Time experiment for executable \"%s\" to be run on host \"%s\".  Further you've chosed a sample rate of \"%d\".<br><br></p>" ) );
