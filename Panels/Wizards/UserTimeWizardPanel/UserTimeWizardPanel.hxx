...
#define PANEL_CLASS_NAME UserTimeWizardPanel   // Change the value of the define
                                         // to the name of your new class.
//! UserTimeWizardPanel Class
class UserTimeWizardPanel  : public Panel
{
  //! Q_OBJECT is needed as there are slots defined for the class
  Q_OBJECT
public:
  //! UserTimeWizardPanel() - A default constructor the the Panel Class.
  UserTimeWizardPanel();  // Default construct

  //! UserTimeWizardPanel(PanelContainer *pc, const char *name)
     ...
     */
  UserTimeWizardPanel(PanelContainer *pc, const char *n); // Active constructor

  //! ~UserTimeWizardPanel() - The default destructor.
  ~UserTimeWizardPanel();  // Active destructor
  ...
  */
  ...
  QWidget* topWidget;
    QFrame* topFrame;
    QWidgetStack* UserTimeWizardPanelStack;
