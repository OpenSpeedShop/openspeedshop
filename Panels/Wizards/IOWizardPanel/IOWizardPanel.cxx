...
sv->setResizePolicy( QScrollView::Manual );
    ...
    IOFormLayout = new QVBoxLayout( sv->viewport(), 1, 2, getName() );
...
// End: add the bottom portion: The "wizard mode" and "brought to you by"
   ...
   IOFormLayout->addLayout( bottomLayout );
    languageChange();
...
nprintf(DEBUG_PANELS) ("vSummaryPageFinishButtonSelected() \n");
  ...
  Panel *p = getPanelContainer()->getMasterPC()->dl_create_and_add_panel("IO", getPanelContainer(), (void *)argument);
