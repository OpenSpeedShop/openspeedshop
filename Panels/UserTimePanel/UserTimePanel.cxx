...
//        unsigned int sampling_rate = lao->paramList.toUInt();
        ...
        try
        {
          ...
          if( cgrp.size() > 0 )
          {
            ...
            Collector usertimeCollector = *ci;
            usertimeCollector.setParameterValue("sampling_rate", sampling_rate);
// printf("getName=(%s)\n", getName() );
...
//    usertimeCollector.setParameterValue("event", event_value.ascii() );
