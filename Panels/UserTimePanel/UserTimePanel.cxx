...
//      Thread t1 = *ti; 
  ...
  if( expID == -1 )
  {
    ...
    { 
      command = QString("expCreate -x %1 usertime\n").arg(pidStr);
    } else
    {
...
//  fprintf(stdout, "A: MY VALUE! = (%d)\n", val);
  ...
  {
    nprintf( DEBUG_PANELS ) ("usertime has been requested to open an existing experiment!!!\n");
...
void
UserTimePanel::manageCollectorsAndProcessesSelected()
{
  nprintf( DEBUG_PANELS ) ("UserTimePanel::manageCollectorsAndProcessesSelected()\n");
...
// printf("UserTimePanel::listener(%s) requested.\n", mo->msgType );
  ...
  {
//    printf("UserTimePanel::listener() ClosingDownObject!\n");
