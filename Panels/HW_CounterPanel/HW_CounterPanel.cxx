 ...
 */
HW_CounterPanel::HW_CounterPanel(PanelContainer *pc, const char *n, void *argument) : Panel(pc, n)
{
...
//  fprintf(stdout, "A: MY VALUE! = (%d)\n", val);
  ...
  {
    nprintf( DEBUG_PANELS ) ("hwCounter has been requested to open an existing experiment!!!\n");
...
topPC->dl_create_and_add_panel("HW Counter Wizard", bestFitPC, (char *)this);
    } else
    {
...
void
HW_CounterPanel::manageCollectorsAndProcessesSelected()
{
  nprintf( DEBUG_PANELS ) ("HW_CounterPanel::manageCollectorsAndProcessesSelected()\n");
...
// printf("HW_CounterPanel::listener(%s) requested.\n", mo->msgType );
  ...
  {
//    printf("HW_CounterPanel::listener() ClosingDownObject!\n");
