...
#ifndef ConstructNewExperimentPanel_H_H
#define ConstructNewExperimentPanel_H_H
...
public:
  //! ConstructNewExperimentPanel(PanelContainer *pc, const char *name)
     ...
     */
  ConstructNewExperimentPanel(PanelContainer *pc, const char *n, void *argument);

  //! ~ConstructNewExperimentPanel() - The default destructor.
  ~ConstructNewExperimentPanel();  // Active destructor
...
#endif // ConstructNewExperimentPanel_H_H
