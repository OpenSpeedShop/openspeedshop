...
#include "ConstructNewExperimentPanel.hxx"   // Change this to your new class header file name
...
bool
ConstructNewExperimentPanel::menu(QPopupMenu* contextMenu)
{
  nprintf( DEBUG_PANELS ) ("ConstructNewExperimentPanel::menu() requested.\n");
  ...
  qaction = new QAction( this,  "ConstructNewExperimentPanelSaveAs");
  qaction->addTo( contextMenu );
  qaction->setText( "Export Data..." );
  connect( qaction, SIGNAL( activated() ), this, SLOT( saveAsSelected() ) );
  qaction->setStatusTip( tr("Export data from all the ConstructNewExperimentPanel's windows to an ascii file.") );

  return( TRUE );
}

void
ConstructNewExperimentPanel::manageCollectorsAndProcessesSelected()
{
  nprintf( DEBUG_PANELS ) ("ConstructNewExperimentPanel::manageCollectorsAndProcessesSelected()\n");
...
void
ConstructNewExperimentPanel::manageDataSetsSelected()
{
  nprintf( DEBUG_PANELS ) ("ConstructNewExperimentPanel::manageDataSetsSelected()\n");
 ...
 */
void 
ConstructNewExperimentPanel::save()
{
  nprintf( DEBUG_PANELS ) ("ConstructNewExperimentPanel::save() requested.\n");
}
 ...
 */
void 
ConstructNewExperimentPanel::saveAs()
{
  nprintf( DEBUG_SAVEAS ) ("ConstructNewExperimentPanel::saveAs() requested.\n");
}

//! This function listens for messages.
int 
ConstructNewExperimentPanel::listener(void *msg)
{
  nprintf( DEBUG_MESSAGES ) ("ConstructNewExperimentPanel::listener() requested.\n");
...
// printf("ConstructNewExperimentPanel::listener(%s) requested.\n", mo->msgType );
  ...
  {
//    printf("ConstructNewExperimentPanel::listener() ClosingDownObject!\n");
...
void
ConstructNewExperimentPanel::updateInitialStatus()
{
  loadMain();
}
...
void
ConstructNewExperimentPanel::saveAsSelected()
{
  ...
  if( sfd == NULL )
  {
    ...
    sfd->setSelection(QString("ConstructNewExperimentPanel.txt"));
    QString types(
                  "Any Files (*);;"
                  "Text files (*.txt);;"
                  );
...
{
  nprintf( DEBUG_PANELS ) ("ConstructNewExperimentPanel::loadSourcePanel()\n");
...
void
ConstructNewExperimentPanel::wakeUpAndCheckExperimentStatus()
{
  printf("ConstructNewExperimentPanel::wakeUpAndCheckExperimentStatus() entered\n");
}
 ...
 */
void
ConstructNewExperimentPanel::updateStatus()
{
  if( expID <= 0 )
  {
...
void
ConstructNewExperimentPanel::statusUpdateTimerSlot()
{
//  statusTimer->stop();
  updateStatus();
}
