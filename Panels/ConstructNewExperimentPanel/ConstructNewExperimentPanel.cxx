...
bool
ConstructNewExperimentPanel::detachFromProgramSelected()
{
  nprintf( DEBUG_PANELS ) ("ConstructNewExperimentPanel::detachFromProgramSelected()\n");
...
void
ConstructNewExperimentPanel::manageCollectorsSelected()
{
  nprintf( DEBUG_PANELS ) ("ConstructNewExperimentPanel::manageCollectorsSelected()\n");
...
void
ConstructNewExperimentPanel::manageProcessesSelected()
{
  nprintf( DEBUG_PANELS ) ("ConstructNewExperimentPanel::manageProcessesSelected()\n");
}   
...
ConstructNewExperimentPanel::saveAsSelected()
{
  ...
  if( sfd == NULL )
  {
    ...
    sfd->setSelection(QString("ConstructNewExperimentPanel.html"));
    QString types(
                  "Any Files (*);;"
