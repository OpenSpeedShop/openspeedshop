...
//      Thread t1 = *ti; 
  ...
  if( expID == -1 )
  {
    ...
    { 
      command = QString("expCreate -x %1 io\n").arg(pidStr);
    } else
    {
...
void
IOPanel::manageCollectorsAndProcessesSelected()
{
...
// printf("IOPanel::listener(%s) requested.\n", mo->msgType );
  ...
  {
//    printf("IOPanel::listener() ClosingDownObject!\n");
