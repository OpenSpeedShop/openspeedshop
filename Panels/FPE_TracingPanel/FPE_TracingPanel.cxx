...
//        unsigned int sampling_rate = lao->paramList.toUInt();
        ...
        try
        {
          ...
          if( cgrp.size() > 0 )
          {
            ...
            Collector fpeTracingCollector = *ci;
            fpeTracingCollector.setParameterValue("sampling_rate", sampling_rate);
// printf("getName=(%s)\n", getName() );
...
//    fpeTracingCollector.setParameterValue("event", event_value.ascii() );
