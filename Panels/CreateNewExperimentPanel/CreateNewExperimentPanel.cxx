...
{
  printf("CreateNewExperimentPanel::CreateNewExperimentPanel() constructor called\n");
  ...
  QWidget *createNewExperimentPanelContainerWidget = new QWidget( getBaseWidgetFrame(),
...
//  topPC->rightPanelContainer->splitVertical();
  ...
  createNewExperimentPanelContainerWidget->show();
  topPC->show();
  topLevel = TRUE;
  topPC->topLevel = TRUE;
...
CreateNewExperimentPanel::~CreateNewExperimentPanel()
{
  printf("  CreateNewExperimentPanel::~CreateNewExperimentPanel() destructor called\n");
  delete frameLayout;
}
...
{
  printf("CreateNewExperimentPanel::saveAs() requested.\n");
}
...
{
  printf("CreateNewExperimentPanel::listener() requested.\n");
