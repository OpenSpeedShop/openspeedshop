...
{
  nprintf( DEBUG_CONST_DESTRUCT ) ("CreateNewExperimentPanel::CreateNewExperimentPanel() constructor called\n");
  ...
  QWidget *CreateNewExperimentControlPanelContainerWidget = new QWidget( getBaseWidgetFrame(),
                                        "CreateNewExperimentControlPanelContainerWidget" );
  topPC = createPanelContainer( CreateNewExperimentControlPanelContainerWidget,
                              "PCSamplingControlPanel_topPC", NULL,
                              pc->getMasterPCList() );
  frameLayout->addWidget( CreateNewExperimentControlPanelContainerWidget );
...
printf("# theApplication.attachCollector(theCollector.getValue());\n");
  ...
  CreateNewExperimentControlPanelContainerWidget->show();
  topPC->show();
  topLevel = TRUE;
  topPC->topLevel = TRUE;
...
CreateNewExperimentPanel::~CreateNewExperimentPanel()
{
  nprintf( DEBUG_CONST_DESTRUCT ) ("  CreateNewExperimentPanel::~CreateNewExperimentPanel() destructor called\n");
  delete frameLayout;
}
...
{
  nprintf( DEBUG_PANELS ) ("CreateNewExperimentPanel::menu() requested.\n");
...
void
CreateNewExperimentPanel::loadNewProgramSelected()
{
  nprintf( DEBUG_PANELS ) ("CreateNewExperimentPanel::loadNewProgramSelected()\n");
...
bool
CreateNewExperimentPanel::detachFromProgramSelected()
{
  nprintf( DEBUG_PANELS ) ("CreateNewExperimentPanel::detachFromProgramSelected()\n");
...
void
CreateNewExperimentPanel::attachToExecutableSelected()
{
  nprintf( DEBUG_PANELS ) ("CreateNewExperimentPanel::attachToExecutableSelected()\n");
  if( runnableFLAG == TRUE )
  {
    if( detachFromProgramSelected() == FALSE )
    {
...
{
  nprintf( DEBUG_PANELS ) ("CreateNewExperimentPanel::manageCollectorsSelected()\n");
}   

void
CreateNewExperimentPanel::manageProcessesSelected()
{
  nprintf( DEBUG_PANELS ) ("CreateNewExperimentPanel::managerProcessesSelected()\n");
}   

void
CreateNewExperimentPanel::manageDataSetsSelected()
{
  nprintf( DEBUG_PANELS ) ("CreateNewExperimentPanel::managerDataSetsSelected()\n");
}   
...
{
  nprintf( DEBUG_PANELS ) ("CreateNewExperimentPanel::save() requested.\n");
}
...
{
  nprintf( DEBUG_SAVEAS ) ("CreateNewExperimentPanel::saveAs() requested.\n");
}
...
{
  nprintf( DEBUG_MESSAGES ) ("CreateNewExperimentPanel::listener() requested.\n");
...
void
CreateNewExperimentPanel::updateInitialStatus()
{
...
void
CreateNewExperimentPanel::saveAsSelected()
{
  ...
  if( sfd == NULL )
  {
    ...
    sfd->setSelection(QString("CreateNewExperimentPanel.html"));
    QString types(
                  "Any Files (*);;"
  ...
  if( sfd->exec() == QDialog::Accepted )
  {
    ...
    { 
      ...
      *sao->ts << "<title>CreateNewExperimentReport</title>";
      *sao->ts << "<h2>CreateNewExperimentReport</h2>";
      *sao->ts << "</head>";
...
void
CreateNewExperimentPanel::loadSourcePanel()
{
