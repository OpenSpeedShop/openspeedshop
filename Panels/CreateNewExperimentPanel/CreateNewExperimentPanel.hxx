#ifndef CREATENEWEXPERIMENT_H
#define CREATENEWEXPERIMENT_H
...
//! Creates the CreateNewExperimentPanel that controls the pcSampling experiment.
class CreateNewExperimentPanel  : public Panel
{
  //! Q_OBJECT is needed as there are slots defined for the class
  Q_OBJECT
public:
  //! CreateNewExperimentPanel() - A default constructor the the Panel Class.
  CreateNewExperimentPanel();  // Default construct
