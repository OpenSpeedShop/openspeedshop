...
////////////////////////////////////////////////////////////////////////////////
  ...
  plugin_entry->plugin_short_description = "Obsoleted panel type.";
  plugin_entry->plugin_name =  "TopPanel.so";
  plugin_entry->plugin_location = "$OPENSPEEDSHOP_PLUGIN_PATH";
  plugin_entry->plugin_entry_point = "panel_init";
  plugin_entry->menu_heading =  "&Tools"; // Leaving this blank hides the menu entry.
  plugin_entry->menu_label =  "Top Panel";
  plugin_entry->menu_accel = "Alt+T";
