...
static std::string VIEW_fpe_short = "Report the time spent in each fpe function.";
static std::string VIEW_fpe_long  = "\nA positive integer can be added to the end of the keyword"
                                      ...
                                      "\n\t'-v Trace' will produce a report of each individual  call to an fpe"
                                      " function."
                                      " It will be sorted in ascending order of the starting time for the event."
                                      " The information available for display from an 'fpe' experiment is very"
                                      " limited when compared to what is available from an 'fpet' experiment."
                                      ...
                                      " \n\t'-m percent' reports the percent of fpe time the function represents."
                                      " \n\t'-m stddev' reports the standard deviation of the average fpe time"
