...
plugin_entry->plugin_short_description = (char *) "Manages setup for the User Time Experiment.";
  plugin_entry->plugin_name = (char *) "UserTimePanelWizard.so";
  ...
  plugin_entry->menu_label = (char *) "User Time Wizard";
  plugin_entry->menu_accel = (char *) "Alt+8";
  plugin_entry->panel_type = (char *) "User Time Wizard";
