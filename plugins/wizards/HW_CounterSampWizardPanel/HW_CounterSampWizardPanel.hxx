...
#ifndef HW_COUNTERSAMPWIZARDPANEL_H
#define HW_COUNTERSAMPWIZARDPANEL_H
...
#define PANEL_CLASS_NAME HW_CounterSampWizardPanel   // Change the value of the define
                                         // to the name of your new class.
//! HW_CounterSampWizardPanel Class
class HW_CounterSampWizardPanel  : public Panel
{
  //! Q_OBJECT is needed as there are slots defined for the class
  Q_OBJECT
public:
  //! HW_CounterSampWizardPanel() - A default constructor the the Panel Class.
  HW_CounterSampWizardPanel();  // Default construct

  //! HW_CounterSampWizardPanel(PanelContainer *pc, const char *name)
     ...
     */
  HW_CounterSampWizardPanel(PanelContainer *pc, const char *n, ArgumentObject *ao);

  //! ~HW_CounterSampWizardPanel() - The default destructor.
  ~HW_CounterSampWizardPanel();  // Active destructor
...
#endif // HW_COUNTERSAMPWIZARDPANEL_H
