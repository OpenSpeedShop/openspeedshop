...
////////////////////////////////////////////////////////////////////////////////
  ...
  plugin_entry->plugin_short_description = (char *) "Manages the Memory Tracing experiment.  Use\na left mouse click on the menu icon or use right mouse\nbutton down on tab for menu options.";
  plugin_entry->plugin_name = (char *) "MEMPanel.so";
  ...
  plugin_entry->menu_label = (char *) "Memory Tracing";
  plugin_entry->menu_accel = (char *) "Alt+K";
  plugin_entry->panel_type = (char *) "MEM";
