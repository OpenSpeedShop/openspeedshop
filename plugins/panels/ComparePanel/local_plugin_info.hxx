...
////////////////////////////////////////////////////////////////////////////////
  ...
  plugin_entry->plugin_description = "This panel allows the user to interface to the \"Compare\" feature of Open|SpeedShop.\nThis panel allows the user to select 2 experiments to compare results (from one run to another).  It also allows the user to compare groups of process/threads from within one executable.";
  plugin_entry->plugin_short_description = "Allows the user to setup compare processes/experiments feature.";
  plugin_entry->plugin_name =  "ComparePanel.so";
  plugin_entry->plugin_location = "$OPENSS_PLUGIN_PATH";
  plugin_entry->plugin_entry_point = "panel_init";
  plugin_entry->menu_heading =  "";
  plugin_entry->sub_menu_heading =  "";
  plugin_entry->menu_label =  "ComparePanel";
  plugin_entry->menu_accel =  " ";
  plugin_entry->panel_type =  "ComparePanel";
  plugin_entry->preference_category =  "ComparePanel";
