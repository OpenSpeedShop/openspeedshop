...
////////////////////////////////////////////////////////////////////////////////
  ...
  plugin_entry->plugin_short_description = "Manages the Hardware Counter Time experiment.  Use\na left mouse click on the menu icon or use right mouse\nbutton down on tab for menu options.";
  plugin_entry->plugin_name =  "HWCTimePanel.so";
  ...
  plugin_entry->menu_label =  "HWCTime Panel";
  plugin_entry->menu_accel =  "Alt+H";
  plugin_entry->panel_type =  "HWCTime Panel";
