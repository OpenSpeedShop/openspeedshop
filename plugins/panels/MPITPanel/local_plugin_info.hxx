...
////////////////////////////////////////////////////////////////////////////////
  ...
  plugin_entry->plugin_short_description = (char *) "Manages the MPIT experiment. Use a left mouse click\non the menu icon or use right mouse button\ndown on tab for menu options.";
  plugin_entry->plugin_name = (char *) "MPITPanel.so";
  ...
  plugin_entry->menu_label = (char *) "MPIT";
  plugin_entry->menu_accel = (char *) "Alt+N";
  plugin_entry->panel_type = (char *) "MPIT";
