...
////////////////////////////////////////////////////////////////////////////////
  ...
  plugin_entry->plugin_short_description = (char *) "Manages the OpenMP Profile experiment.  Use a left mouse\nclick on the menu icon or use right mouse button\ndown on tab for menu options.";
  plugin_entry->plugin_name = (char *) "OMPTPPanel.so";
  ...
  plugin_entry->menu_label = (char *) "OMPTP";
  plugin_entry->menu_accel = (char *) "Alt+U";
  plugin_entry->panel_type = (char *) "OMPTP";
