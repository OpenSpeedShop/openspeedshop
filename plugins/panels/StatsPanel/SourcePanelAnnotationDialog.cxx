    ...
    : QDialog( parent, name, modal, fl )
{
   ...
   std::cerr << " SourcePanelAnnotationDialog::SourcePanelAnnotationDialog" << " name="  << name << " collectorString=" << collectorString << std::endl;
#endif
...
#if DEBUG_sourceAnno
    printf("SourcePanelAnnotationDialog::languageChange, setting iot_exclusive_times_CheckBox to iot_exclusive_times_CheckBox->isChecked()=%d\n",
...
// printf("SourcePanelAnnotationDialog::languageChange() entered\n");
    ...
    if( globalCollectorString.contains("pcsamp") ) {
       GeneralGroupBox->setTitle( tr( "PCSAMP Experiment Source Panel Metric Annotation Selection Dialog" ) );
    } else if ( globalCollectorString.contains("usertime") ) {
       ...
       GeneralGroupBox->setTitle( tr( "HWCTIME Experiment Source Panel Metric Annotation Selection Dialog" ) );
    } else if ( globalCollectorString.contains("hwc") ) {
       GeneralGroupBox->setTitle( tr( "HWC Experiment Source Panel Metric Annotation Selection Dialog" ) );
    } else if ( globalCollectorString.contains("iot") ) {
       GeneralGroupBox->setTitle( tr( "IOT Experiment Source Panel Metric Annotation Selection Dialog" ) );
       VTraceGroupBox->setTitle( tr( "IOT Experiment Event List (-v trace) ONLY" ) );
    } else if (globalCollectorString.contains("io") ) {
       GeneralGroupBox->setTitle( tr( "IO Experiment Source Panel Metric Annotation Selection Dialog" ) );
    } else if ( globalCollectorString.contains("mpit") ) {
       GeneralGroupBox->setTitle( tr( "MPIT Experiment Source Panel Metric Annotation Selection Dialog" ) );
       VTraceGroupBox->setTitle( tr( "MPIT Experiment Event List (-v trace) ONLY" ) );
    } else if ( globalCollectorString.contains("mpi") ) {
       GeneralGroupBox->setTitle( tr( "MPI Experiment Source Panel Metric Annotation Selection Dialog" ) );
    } else if ( globalCollectorString.contains("fpe") ) {
       GeneralGroupBox->setTitle( tr( "FPE Experiment Source Panel Metric Annotation Selection Dialog" ) );
    } else {
...
void SourcePanelAnnotationDialog::resetPreferenceDefaults()
{
   ...
   if( globalCollectorString.contains("pcsamp") ) {
...
#ifdef DEBUG_sourceAnno
      printf("SourcePanelAnnotationDialog::resetPreferenceDefaults, setting iot_exclusive_times=(%d) to TRUE\n", iot_exclusive_times);
#endif
     iot_exclusive_times = TRUE;
     iot_exclusive_times_CheckBox->setChecked(iot_exclusive_times);
     iot_inclusive_times = FALSE;
     ...
     io_exclusive_times = TRUE;
#ifdef DEBUG_sourceAnno
      printf("SourcePanelAnnotationDialog::resetPreferenceDefaults, setting io_exclusive_times=(%d) to TRUE\n", iot_exclusive_times);
#endif
     io_exclusive_times_CheckBox->setChecked(io_exclusive_times);
     io_min = FALSE;
     io_min_CheckBox->setChecked(io_min);
...
{
#ifdef DEBUG_sourceAnno
    printf("SourcePanelAnnotationDialog::matchPreferencesToStack, &StatsPanel::current_list_of_iot_annotation_modifiers=(%x)\n", &StatsPanel::current_list_of_iot_annotation_modifiers);
#endif
...
{
#ifdef DEBUG_sourceAnno
    printf("SourcePanelAnnotationDialog::listItemSelected, &StatsPanel::current_list_of_iot_annotation_modifiers=(%x)\n", &StatsPanel::current_list_of_iot_annotation_modifiers);
#endif
  if( lvi == NULL )
  {
    return;
...
#endif
#ifdef DEBUG_sourceAnno
     printf("SourcePanelAnnotationDialog::applyPreferences, iot_exclusive_times=(%d)\n", iot_exclusive_times);
     printf("SourcePanelAnnotationDialog::applyPreferences, iot_inclusive_times=(%d)\n", iot_inclusive_times);
     printf("SourcePanelAnnotationDialog::applyPreferences, iot_min=(%d)\n", iot_min);
#endif
   } else if (globalCollectorString.contains("io") ) {
...
{
#ifdef DEBUG_sourceAnno
    printf("SourcePanelAnnotationDialog::buttonApplySelected, &StatsPanel::current_list_of_iot_annotation_modifiers=(%x)\n", &StatsPanel::current_list_of_iot_annotation_modifiers);
#endif
    applyPreferences();
}
...
#ifdef DEBUG_sourceAnno
    printf("SourcePanelAnnotationDialog::buttonOkSelected, &StatsPanel::current_list_of_iot_annotation_modifiers=(%x)\n", &StatsPanel::current_list_of_iot_annotation_modifiers);
#endif
...
{
#ifdef DEBUG_sourceAnno
    printf("SourcePanelAnnotationDialog::savePreferences, &StatsPanel::current_list_of_iot_modifiers=(%x)\n", &StatsPanel::current_list_of_iot_modifiers);
#endif
}
