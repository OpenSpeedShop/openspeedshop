...
*/
SPTextEdit::SPTextEdit( StatsPanel *sp, QWidget *parent, const char *n )
    : QTextEdit( parent, n )
{
...
{
  nprintf(DEBUG_PANELS) ("SPTextEdit::createPopupMenu, Hello from down under the hood.\n");
  ...
  panelMenu->setCaption("StatsPanel menu");
  ...
  popupMenu->insertSeparator();
  statsPanel->createPopupMenu(popupMenu, pos);
  return popupMenu;
}
...
//    statsPanel->addWhatsThis( vbar, statsPanel );
  }
  ...
  nprintf(DEBUG_PANELS) ("SPTextEdit::clearScrollBar(), depth=%d\n", vannotatePixmap->depth() );
