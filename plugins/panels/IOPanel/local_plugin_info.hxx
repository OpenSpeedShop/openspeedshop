...
////////////////////////////////////////////////////////////////////////////////
  ...
  plugin_entry->plugin_short_description = (char *) "Manages the Input/Output experiment.  Use a left\nmouse click on the menu icon or use right mouse button\ndown on tab for menu options.";
  plugin_entry->plugin_name = (char *) "IOPanel.so";
  ...
  plugin_entry->menu_label = (char *) "IO";
  plugin_entry->menu_accel = (char *) "Alt+I";
  plugin_entry->panel_type = (char *) "IO";
