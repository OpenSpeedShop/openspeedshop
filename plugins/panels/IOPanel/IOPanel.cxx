...
void
IOPanel::compareExperimentsSelected()
{
  nprintf( DEBUG_PANELS ) ("IOPanel::compareExperimentsSelected()\n");
...
// printf("io: eo->Determine_Status()=%d\n", eo->Determine_Status() );
    if( eo->Determine_Status() == ExpStatus_NonExistent || eo->Determine_Status() == ExpStatus_InError || eo->Determine_Status() == ExpStatus_Terminated )
    {
    statusLabelText->setText( tr(QString("Loaded saved data from file.") ) );
    runnableFLAG = FALSE;
...
void
IOPanel::loadProgramSelected()
{
// printf("IOPanel::loadProgramSelected()\n");
  mw->executableName = QString::null;
  ...
  {
// printf("IOPanel::loadProgramSelected() executableName=%s\n", mw->executableName.ascii() );
    executableNameStr = mw->executableName;
    QString command =
