...
////////////////////////////////////////////////////////////////////////////////
  ...
  plugin_entry->plugin_short_description = "Manages the CompareExperiments experiment.  Use a\nleft mouse click on the menu icon or use right mouse button\ndown on tab for menu options.";
  plugin_entry->plugin_name =  "CompareExperimentsPanel.so";
  ...
  plugin_entry->menu_label =  "Compare Experiments";
  plugin_entry->menu_accel =  "Alt+M";
  plugin_entry->panel_type =  "Compare Experiments";
