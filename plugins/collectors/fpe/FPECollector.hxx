...
/** @file
 *
 * Declaration of the FPECollector class.
 *
 */

#ifndef _FPECollector_
#define _FPECollector_
...
namespace OpenSpeedShop { namespace Framework {
    ...
    /**
     * FPE event tracing collector.
     *
     * Intercepts all calls to FPE functions that perform any significant amount
