...
/** @file
 *
 * Declaration of the OmptPCollector class.
 *
 */

#ifndef _OmptPCollector_
#define _OmptPCollector_
...
namespace OpenSpeedShop { namespace Framework {
    ...
    /**
     * OmptP profiling collector.
     *
     * Intercepts all calls to OmptP functions that perform any significant amount
     * of work and records, for each call, the current stack trace,
     * and time spent in the call.
     *
     */
    class OmptPCollector :
