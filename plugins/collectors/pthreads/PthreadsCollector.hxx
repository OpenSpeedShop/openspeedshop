...
/** @file
 *
 * Declaration of the PthreadsCollector class.
 *
 */

#ifndef _PthreadsCollector_
#define _PthreadsCollector_
...
namespace OpenSpeedShop { namespace Framework {
    ...
    /**
     * Pthreads event tracing collector.
     *
     * Intercepts all calls to Pthreads functions that perform any significant amount
     * of work (primarily those that send messages) and records, for each call,
     * the current stack trace and start/end time.
     *
     * PthreadsT event tracing collector.
     *
     * Same capability as Pthreads event tracing but records extended information:
     * arguments, return value, syscall number, pathname (if used as an arg).
     *
     */
    class PthreadsCollector :
